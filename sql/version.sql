...
CREATE OR REPLACE FUNCTION _timeudb_functions.get_git_commit()
...
CREATE OR REPLACE FUNCTION _timeudb_functions.get_os_info()
...
CREATE OR REPLACE FUNCTION _timeudb_functions.tsl_loaded() RETURNS BOOLEAN
