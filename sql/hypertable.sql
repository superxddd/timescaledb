...
CREATE OR REPLACE FUNCTION _timeudb_functions.insert_blocker() RETURNS trigger
...
CREATE OR REPLACE FUNCTION _timeudb_functions.continuous_agg_invalidation_trigger() RETURNS TRIGGER
