...
DROP FUNCTION _timeudb_internal.attach_osm_table_chunk( hypertable REGCLASS, chunk REGCLASS);
DROP FUNCTION _timeudb_internal.alter_job_set_hypertable_id( job_id INTEGER, hypertable REGCLASS );
DROP FUNCTION _timeudb_internal.unfreeze_chunk( chunk REGCLASS);
-- Drop dimension partition metadata table
ALTER EXTENSION timeudb DROP TABLE _timeudb_catalog.dimension_partition;
DROP TABLE IF EXISTS _timeudb_catalog.dimension_partition;

DROP FUNCTION IF EXISTS timeudb_experimental.add_policies;
DROP FUNCTION IF EXISTS timeudb_experimental.remove_policies;
DROP FUNCTION IF EXISTS timeudb_experimental.remove_all_policies;
DROP FUNCTION IF EXISTS timeudb_experimental.alter_policies;
DROP FUNCTION IF EXISTS timeudb_experimental.show_policies;
...
--
-- Rebuild the catalog table `_timeudb_catalog.chunk`
--
...
CREATE TABLE _timeudb_config.bgw_job_tmp (LIKE _timeudb_config.bgw_job);
INSERT INTO _timeudb_config.bgw_job_tmp SELECT * FROM _timeudb_config.bgw_job;
...
INSERT INTO _timeudb_config.bgw_job SELECT * FROM _timeudb_config.bgw_job_tmp ORDER BY id;
...
DROP FUNCTION IF EXISTS _timeudb_internal.policy_retention_check(JSONB);
DROP FUNCTION IF EXISTS _timeudb_internal.policy_compression_check(JSONB);
DROP FUNCTION IF EXISTS _timeudb_internal.policy_reorder_check(JSONB);
DROP FUNCTION IF EXISTS _timeudb_internal.policy_refresh_continuous_aggregate_check(JSONB);
...
ALTER EXTENSION timeudb DROP SEQUENCE _timeudb_catalog.continuous_agg_migrate_plan_step_step_id_seq;
ALTER EXTENSION timeudb DROP TABLE _timeudb_catalog.continuous_agg_migrate_plan_step;
DROP TABLE _timeudb_catalog.continuous_agg_migrate_plan_step;
...
CREATE FUNCTION @extschema@.create_hypertable(
    ...
    chunk_sizing_func       REGPROC = '_timeudb_internal.calculate_chunk_interval'::regproc,
