...
GRANT USAGE ON SCHEMA timeudb_experimental TO PUBLIC;
...
CREATE TABLE _timeudb_catalog.chunk_copy_operation (
  ...
  chunk_id integer NOT NULL REFERENCES _timeudb_catalog.chunk (id) ON DELETE CASCADE,
  source_node_name name NOT NULL,
  dest_node_name name NOT NULL,
  delete_on_source_node bool NOT NULL -- is a move or copy activity
);

GRANT SELECT ON _timeudb_catalog.chunk_copy_operation_id_seq TO PUBLIC;
GRANT SELECT ON _timeudb_catalog.chunk_copy_operation TO PUBLIC;
