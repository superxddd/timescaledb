...
CREATE TABLE _timeudb_catalog.continuous_aggs_bucket_function(
  mat_hypertable_id integer PRIMARY KEY REFERENCES _timeudb_catalog.hypertable (id) ON DELETE CASCADE,
...
GRANT SELECT ON _timeudb_catalog.continuous_aggs_bucket_function TO PUBLIC;
