...
DROP TYPE IF EXISTS _timeudb_internal.dimension_info CASCADE;
...
DROP FUNCTION IF EXISTS _timeudb_functions.cagg_validate_query(TEXT);
...
DROP PROCEDURE IF EXISTS _timeudb_functions.policy_compression_execute(INTEGER, INTEGER, ANYELEMENT, INTEGER, BOOLEAN, BOOLEAN, BOOLEAN);
DROP PROCEDURE IF EXISTS _timeudb_internal.policy_compression_execute(INTEGER, INTEGER, ANYELEMENT, INTEGER, BOOLEAN, BOOLEAN, BOOLEAN);
CREATE PROCEDURE
...
DROP FUNCTION _timeudb_functions.chunk_constraint_add_table_constraint(
    chunk_constraint_row  _timeudb_catalog.chunk_constraint
);

CREATE FUNCTION _timeudb_functions.chunk_constraint_add_table_constraint(
    chunk_constraint_row  _timeudb_catalog.chunk_constraint
)
