DROP FUNCTION _timeudb_internal.ping_data_node(NAME);
...
-- are recreated.
CREATE OR REPLACE FUNCTION _timeudb_internal.ping_data_node(node_name NAME, timeout INTERVAL = NULL) RETURNS BOOLEAN
