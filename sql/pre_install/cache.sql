...
-- This file contains infrastructure for cache invalidation of TIMEUDB
-- metadata caches kept in C. Please look at cache_invalidate.c for a
-- description of how this works.
CREATE TABLE _timeudb_cache.cache_inval_hypertable();

-- For notifying the scheduler of changes to the bgw_job table.
CREATE TABLE _timeudb_cache.cache_inval_bgw_job();
...
-- etc.
CREATE TABLE _timeudb_cache.cache_inval_extension();

GRANT SELECT ON ALL TABLES IN SCHEMA _timeudb_cache TO PUBLIC;
