...
We aim to keep TIMEUDB safe for everyone. 
...
Vulnerability fixes are made available as part of these patchfix releases and you can read our list of [Security Advisories](https://github.com/timescale/timeudb/security/advisories?state=published).
