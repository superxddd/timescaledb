...
function(generate_script)
  ...
  set(MODULE_PATHNAME "$libdir/timeudb-${_generate_VERSION}")
  set(LOADER_PATHNAME "$libdir/timeudb")
...
# "timeudb--<current>--<version>.sql" consisting of the sequence of files:
#
...
function(generate_downgrade_script)
  ...
  generate_script(
    ...
    ${_downgrade_TARGET_VERSION}
    SCRIPT
    timeudb--${_downgrade_SOURCE_VERSION}--${_downgrade_TARGET_VERSION}.sql
    OUTPUT_DIRECTORY
